...
<html lang="en">
  <head>
    ...
    })(window,document,'script','dataLayer','GTM-5VFJZCL');</script>
    ...
    <header>
      ...
      <div class="mobile-search">
        <form action="{{route('search')}}">
          <input type="text" placeholder="Search Product..." value="" class="search_keyword search_click" name="keyword" />
            ...
            <div class="row">
              <div class="header_top_data">
                <div class="header_number">
                   <a href="tel:{{$contact->hotline}}"><i class="fa-solid fa-phone"></i> {{$contact->hotline}}</a>
                </div>
               <div class="header_social">
                     <ul class="social_link social_head">
                      @foreach($socialicons as $value)
                      <li class="social_list">
                        <a class="mobile-social-link" href="{{$value->link}}" style="background:{{$value->color}}"><i class="{{$value->icon}}"></i></a>
                      </li>
                      @endforeach
                    </ul>
              </div>
                        ...
                        <li class="cart-dialog" id="cart-qty">
                          ...
                          <div class="cshort-summary">
                            <ul>
                              ...
                              <li><a>{{$value->name}}</a> @if($value->options->product_size)<p class="d-block">Size: {{$value->options->product_size}}</p> @endif</li>
                              <li>Qty: {{$value->qty}}</li>
                              <li>
                                <p>৳{{$value->price}}</p>
                            ...
                            <a href="{{route('customer.checkout')}}" class="go_cart"> Go To Checkout</a>
                          </div>
                        </li>
                      </ul>
                    </div>
...
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-5VFJZCL"
