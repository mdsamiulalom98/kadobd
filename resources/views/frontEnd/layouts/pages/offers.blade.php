...
@endpush
@push('seo')
    <meta name="app-url" content="route('newarrivals')" />
    ...
    <meta name="keywords" content="Discount Products" />
    <!-- Twitter Card data -->
    <meta name="twitter:card" content="product" />
    <meta name="twitter:site" content="Discount Products" />
    ...
    <meta property="og:url" content="route('offers')" />
    ...
    <meta property="og:site_name" content="Discount Products" />
@endpush
@section('content')
