                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-sm-5 position-relative">
                                ...
                                <div class="discount">
                                    <p> @php $discount=(((($details->old_price)-($details->new_price))*100) / ($details->old_price)) @endphp {{ number_format($discount, 0) }}% OFF</p>
                                </div>
                                @endif
                                            ...
                                            <form action="{{ route('cart.store') }}" method="POST" name="formName">
                                                ...
                                                @if ($productcolors->count() > 0)
                                                                    ...
                                                                    @foreach ($productcolors as $key=>$procolor)
                                                                        <div class="selector-item">
                                                                            <input type="radio"
                                                                                ...
                                                                                name="product_color"
                                                                                class="selector-item_radio emptyalert stock_check stock_color" data-color="{{ $procolor->color}}"
                                                                                required />
                                                                            <label for="fc-option{{ $key }}"
                                                                                style="background-color: {{ $procolor->color }}"
                                                    ...
                                                    @endif @if ($productsizes->count() > 0)
                                                                        ...
                                                                        @foreach ($productsizes as $key=>$prosize)
                                                                            <div class="selector-item">
                                                                                <input type="radio"
                                                                                    ...
                                                                                    value="{{ $prosize->size}}"
                                                                                    name="product_size"
                                                                                    class="selector-item_radio emptyalert stock_check stock_size" data-size="{{ $prosize->size}}" 
                                                                                    required />
                                                                                <label
                                                                                    for="f-option{{ $key }}"
                                                        ...
                                                        @endif
                                                        <div class="stock_summary">@if($details->type ==0) <p data-stock="{{$details->quantity}}"><strong>Stock: {{$details->quantity}}</p> @endif</div>
                                                        @if($details->pro_unit)
                                                            <div class="pro_unig">
                                                        ...
                                                        <div class="pro_brand">
                                                         ...
                                                         @if($details->variables_count < 1 && $details->type == 1 || $details->quantity < 1 && $details->type == 0)

                                                         <div class="row">
                                                             <div class="col-sm-12">
                                                                 <a class="details_stock_out">stock out</a>
                                                             </div>
                                                         </div>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <div class="review_summary_inner">
                                    <h5 class="review_title">Reviews & Ratting</h5>
                                    <div class="review_box">
                                        <div class="review_counter">
                                            <ul class="review_excellent">
                                                <li>@if($total_review)
                                                    {{number_format($total_review/$details->reviews_count,2)}}
                                                    @else
                                                    0
                                                    @endif
                                                </li>
                                                <li><span><i class="far fa-star"></i> Excellent</span></li>

                                            </ul>
                                            <ul class="review_counter">
                                            <li>
                                             @php
                                            ...
                                            @endif
                                            <li class="d-block">{{$details->reviews_count}} Ratting</li>
                                            
                                        </ul>
                                    </div>
                                    <div class="review_counter_line"> 
                                        <ul>
                                            <li>5 Star</li> 
                                            <li>
                                                
                                                <div class="progress">
                                                  <div class="progress-bar bg-success" role="progressbar" aria-label="5 start" style="width: 80%;" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                                                </div>  
                                            </li>
                                            <li>({{$five_star->count()}})</li>
                                        </ul>
                                        <!--review line-->
                                        <ul>
                                            <li>4 Star</li> 
                                            <li>
                                                <div class="progress">
                                                  <div class="progress-bar bg-success" role="progressbar" aria-label="4 start" style="width: 40%;" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                                                </div>  
                                            </li>
                                            <li>({{$four_star->count()}})</li>
                                        </ul>
                                        <!--review line-->
                                        <ul>
                                            <li>3 Star</li> 
                                            <li>
                                                <div class="progress">
                                                  <div class="progress-bar bg-success" role="progressbar" aria-label="4 start" style="width: 20%;" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                                                </div>  
                                            </li>
                                            <li>({{$three_star->count()}})</li>
                                        </ul>
                                        <!--review line-->
                                        <ul>
                                            <li>2 Star</li> 
                                            <li>
                                                <div class="progress">
                                                  <div class="progress-bar bg-warning" role="progressbar" aria-label="4 start" style="width: 10%;" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                                                </div>  
                                            </li>
                                            <li>({{$two_star->count()}})</li>
                                        </ul>
                                        <!--review line-->
                                        <ul>
                                            <li>1 Star</li> 
                                            <li>
                                                <div class="progress">
                                                  <div class="progress-bar bg-danger" role="progressbar" aria-label="4 start" style="width: 1%;" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                                                </div>  
                                            </li>
                                            <li>({{$one_star->count()}})</li>
                                        </ul>
                                        <!--review line-->
                                     </div>
                                    <!-- review line end -->
                                            ...
                                            <div class="col-sm-12 col-12">
                                                <div class="review-card">
                                                    <p class="reviewer_name"><i data-feather="message-square"></i>
                                                        {{ $review->name }}</p>
                                                    <p class="review_data">{{ $review->created_at}}</p>
...
<script>
    $(document).ready(function() {
        ...
        $(".plus").click(function() {
            var maxValue = $('.stock_summary p').data('stock');
            console.log('stock',maxValue);
            var $input = $(this).parent().find("input");
        ...
        if(id,color,size){
            $.ajax({
                ...
                success: function(response){
                    $('.stock_summary').html('<p data-stock="' + response + '"><strong>Stock: ' + response + '</strong></p>');
                }
            });   
        }
