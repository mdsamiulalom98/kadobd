                    ...
                    <form action="{{ route('customer.ordersave') }}" method="POST" data-parsley-validate="">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h6>Fill in the information to confirm your bellow form and click on the "Order Now"
                                    button</h6>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" id="word_no"
                                                class="form-control @error('name') is-invalid @enderror" name="word_no"
                                                value="{{ old('word_no') }}" placeholder="Enter word_no name">
                                            @error('word_no')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                            ...
                                            <div class="card-body pt-2">
                                                <div
                                                    ...
                                                    <div class="card form-check payment_method mt-3" data-id="cod">
                                                        ...
                                                        <label class="form-check-label" for="cod">
                                                            <img src="{{ asset('public/frontEnd/images/cod.png') }}"
                                                                width="60px" alt="cod" />
                                                        </label>
                                                    </div>
                                                    <div class="card form-check payment_method mt-3" data-id="bkash">
                                                        <input type="radio" class="form-check-input"
                                                            name="payment_method" id="bkash" value="bkash"
                                                            required="" />
                                                        <label class="form-check-label" for="bkash">
                                                            <img src="{{ asset('public/frontEnd/images/bkash.png') }}"
                                                                width="60px" alt="bkash" />
                                                        </label>
                                                    </div>
                                                    <div class="card form-check payment_method mt-3" data-id="rocket">
                                                        <input type="radio" class="form-check-input"
                                                            name="payment_method" id="rocket" value="rocket"
                                                            required="" />
                                                        <label class="form-check-label" for="rocket">
                                                            <img src="{{ asset('public/frontEnd/images/rocket.png') }}"
                                                                width="60px" alt="rocket" />
                                                        </label>
                                                    </div>
                                                    <div class="card form-check payment_method mt-3" data-id="dbbl">
                                                        <input type="radio" class="form-check-input"
                                                            name="payment_method" id="dbbl" value="dbbl"
                                                            required="" />
                                                        <label class="form-check-label" for="dbbl">
                                                            <img src="{{ asset('public/frontEnd/images/dbbl.png') }}"
                                                                width="60px" alt="dbbl" />
                                                        </label>
                                                    </div>
                                                    <div class="card form-check payment_method mt-1" data-id="brac">
                                                        <input type="radio" class="form-check-input"
                                                            name="payment_method" id="brac" value="brac"
                                                            required="" />
                                                        <label class="form-check-label" for="brac">
                                                            <img src="{{ asset('public/frontEnd/images/brac-bank.png') }}"
                                                                width="60px" alt="brac" />
                                                        </label>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="payment-instruction">
                                                    ...
                                                    <div class="bkashform">
                                                        ...
                                                        <p> 1. ডায়াল মেনু থেকে *247# ডায়াল করুন, অথবা বিকাশ অ্যাপে
                                                            যান।</p>
                                                        ...
                                                        <p> 7. নিচের বক্সে আপনার লেনদেন আইডি এবং যে নম্বর থেকে আপনি টাকা
                                                            পাঠিয়েছেন সেটি লিখুন।</p>
                                                        <p> 8. "ORDER PLACE" বোতামে ক্লিক করুন৷</p>

                                                    </div>
                                                    <div class="rocketform">
                                                        <p>রকেটে টাকা পাঠাতে নিচের ধাপগুলো অনুসরণ করুন: </p>
                                                        <p>1. ডায়াল মেনু থেকে *322# ডায়াল করুন বা রকেট অ্যাপে যান।
                                                        </p>
                                                        <p>2. "টাকা পাঠান" এ ক্লিক করুন। </p>
                                                        ...
                                                        <p>7. নিচের বক্সে আপনার লেনদেন আইডি এবং যে নম্বর থে কে আপনি টাকা
                                                            পাঠিয়েছেন সেটি লিখুন। </p>
                                                        <p>8. "ORDER PLACE" বোতামে ক্লিক করুন </p>
                                                    </div>
                                                    <div class="dbblform">
                                                        ...
                                                        <p> 6. নিচের বক্সে আপনার লেনদেন আইডি এবং যে নম্বর থেকে আপনি টাকা
                                                            পাঠিয়েছেন সেটি লিখুন।</p>
                                                    ...
                                                    <div class="trxform row">
                                                        ...
                                                        <div class="col-sm-6">
                                                            <div class="form-group mb-3">
                                                                ...
                                                                <input type="text" id="trx_id"
                                                                    class="form-control @error('trx_id') is-invalid @enderror"
                                                                    name="trx_id" value="{{ old('trx_id') }}" />
                                                                @error('trx_id')
                                                                    <span class="invalid-feedback" role="alert">
                                                                        <strong>{{ $message }}</strong>
                                                                    </span>
                                    ...
                                    <div class="col-sm-12 custom_check">
                                        <div class="from-group">
                                            <input type="checkbox" value="1" id="savings_pay"> <label
                                                for="savings_pay">Pay with savings balance
                                                ({{ auth()->guard('customer')->user()->savings }} Tk)</label>
                                        </div>
                                    </div>
                                    <div class="col-sm-12">
