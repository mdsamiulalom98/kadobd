        ...
        <div class="card">
            <div class="card-body">
                <form action="{{route('settings.update')}}" method="POST" class=row data-parsley-validate=""  enctype="multipart/form-data">
                    ...
                    <div class="col-sm-4">
                            <div class="form-group">
                               <label for="start_date" class="form-label">Withdraw Start Date</label>
                                <input type="date" value="{{ $edit_data->start_date}}"  class="form-control flatdate" name="start_date">
                            </div>
                        </div>
                        <!--col-sm-3-->
                        <div class="col-sm-4">
                            <div class="form-group">
                               <label for="end_date" class="form-label">Withdraw End Date</label>
                                <input type="date" value="{{ $edit_data->end_date}}" class="form-control flatdate" name="end_date">
                            </div>
                        </div>
                        <!-- col end -->
