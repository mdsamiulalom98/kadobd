      ...
      <div class="navbar-custom">
        <div class="container-fluid">
          ...
          <ul class="list-unstyled topnav-menu topnav-menu-left m-0">
            ...
            <!--<li class="dropdown d-none d-xl-block">-->
            <!--  <a class="nav-link dropdown-toggle waves-effect waves-light" href="{{route('admin.order.create')}}"> <i data-feather="shopping-cart"></i> Pos </a>-->
            <!--</li>-->
          </ul>
            ...
            <ul id="side-menu">
              ...
              <li>
                ...
                <div class="collapse" id="sidebar-landing-page">
                  <ul class="nav-second-level">                   
                    ...
                    <li>
                      <a href="{{route('campaign.index')}}"><i data-feather="file-plus"></i> Manage</a>
                    </li>
                  </ul>
                </div>
              </li>
              ...
              <li>
                ...
                <div class="collapse" id="sidebar-customer">
                  <ul class="nav-second-level">
                    <li>
                      <a href="{{route('customers.index')}}"><i data-feather="file-plus"></i> Customer List</a>
                    </li>
                    <li>
                      <a href="{{route('customer.withdraw_manage','pending')}}"><i data-feather="file-plus"></i> Pending Withdraw</a>
                    </li>
                    <li>
                      <a href="{{route('customer.withdraw_manage','paid')}}"><i data-feather="file-plus"></i> Paid Withdraw</a>
                    </li>
                    <li>
                      <a href="{{route('customer.withdraw_manage','cancelled')}}"><i data-feather="file-plus"></i> Cancelled Withdraw</a>
                    </li>
                  </ul>
                </div>
              </li>
              ...
              <li>
                ...
                <div class="collapse" id="siebar-sitesetting">
                  <ul class="nav-second-level">
                    ...
                    <li>
                      <a href="{{route('commisions.index')}}"><i data-feather="file-plus"></i> Commision Setting</a>
                    </li>
                    <li>
                    ...
                    <li>
                      <a href="{{route('districts.index')}}"><i data-feather="file-plus"></i> District & Area</a>
                    </li>
                    <li>
              ...
              <li>
                ...
                <div class="collapse" id="siebar-expense">
                  <ul class="nav-second-level">
                    <li>
                      <a href="{{route('expensecategories.index')}}"><i data-feather="file-plus"></i> Expense Categories</a>
                    </li>
                    <li>
              ...
              <li>
                ...
                <div class="collapse" id="sitebar-report">
                  <ul class="nav-second-level">
                    ...
                    <li>
                      <a href="{{route('admin.order_report')}}"><i data-feather="file-plus"></i> Sales Reports</a>
                    </li>
                    <li>
                      <a href="{{route('admin.expense_report')}}"><i data-feather="file-plus"></i> Expense Reports</a>
                    </li>
                    <li>
                      <a href="{{route('admin.commision_report')}}"><i data-feather="file-plus"></i> Commision Reports</a>
                    </li>
                    <li>
                      <a href="{{route('admin.loss_profit')}}"><i data-feather="file-plus"></i> Loss/Profit</a>
                    </li>
                    <li>
