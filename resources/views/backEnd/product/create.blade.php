      ...
      <div class="card">
        <div class="card-body">
          <form action="{{route('products.store')}}" method="POST" class="row" data-parsley-validate="" enctype="multipart/form-data">
            ...
            <div class="col-sm-4">
              <div class="form-group mb-3">
                <label for="quantity" class="form-label">Stock (Only single product) </label>
                <input type="text" class="form-control @error('quantity') is-invalid @enderror" name="quantity" value="{{ old('quantity') }}" id="quantity"  />
                @error('quantity')
                <span class="invalid-feedback" role="alert">
                  <strong>{{ $message }}</strong>
                </span>
            ...
            <!-- col end -->
             <div class="col-sm-3 mb-3">
              <div class="form-group">
                ...
                <label class="switch">
                  <input type="checkbox" value="1" id="product_type" name="type">
                  <span class="slider round"></span>
                </label>
                @error('type')
                <span class="invalid-feedback" role="alert">
            ...
            <!-- col end -->
            <div class="increment_variable" style="display:none">
                <div class="row">
                   <div class="col-sm-4">
                      <div class="form-group mb-3">
