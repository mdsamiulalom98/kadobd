...
Route::group(['namespace'=>'Frontend', 'middleware' => ['ipcheck','check_refer']], function() {
    ...
    Route::get('/product-size', [FrontendController::class, 'pro_size'])->name('pro_size');
    Route::get('package-products', [FrontendController::class, 'packageproducts'])->name('packageproducts');
    Route::get('new-arrivals', [FrontendController::class, 'newarrivals'])->name('newarrivals');
    Route::get('/discount-products', [FrontendController::class, 'offers'])->name('offers');
    ...
    Route::get('/cod-charge', [FrontendController::class, 'cod_charge'])->name('cashondelivery.charge');
    ...
    Route::get('/add-to-cart', [ShoppingController::class, 'add_to_cart'])->name('add_to_cart');
...
Route::group(['prefix'=>'customer','namespace'=>'Frontend', 'middleware' => ['ipcheck','check_refer']], function() {
   ...
   Route::get('/order-track', [CustomerController::class, 'order_track'])->name('customer.order_track');
    Route::get('/order-track/result', [CustomerController::class, 'order_track_result'])->name('customer.order_track_result');
      Route::get('cart/withlist', [ShoppingController::class, 'cart_increment_bn'])->name('customer.wishlist');
...
Route::group(['prefix'=>'customer','namespace'=>'Frontend','middleware' => ['customer','ipcheck','check_refer']], function() {
    ...
    Route::get('/savings-pay', [CustomerController::class, 'savings_pay'])->name('savings.pay');
     Route::get('/refferals', [CustomerController::class, 'refferals'])->name('customer.refferals');
    Route::get('/balance', [CustomerController::class, 'balance'])->name('customer.balance');
    Route::get('/withdraws', [CustomerController::class, 'withdraws'])->name('customer.withdraws');
    Route::post('/withdraw-save', [CustomerController::class, 'withdraw_save'])->name('customer.withdraw_save');
...
Route::group(['namespace'=>'Admin','middleware' => ['auth','lock','check_refer'],'prefix'=>'admin'], function() {
    ...
    // commisions
    Route::get('commisions/manage', [AffiliateCommisionController::class,'index'])->name('commisions.index');
    Route::get('commisions/{id}/show', [AffiliateCommisionController::class,'show'])->name('commisions.show');
    Route::get('commisions/create', [AffiliateCommisionController::class,'create'])->name('commisions.create');
    Route::post('commisions/save', [AffiliateCommisionController::class,'store'])->name('commisions.store');
    Route::get('commisions/{id}/edit', [AffiliateCommisionController::class,'edit'])->name('commisions.edit');
    Route::post('commisions/update', [AffiliateCommisionController::class,'update'])->name('commisions.update');
    Route::post('commisions/inactive', [AffiliateCommisionController::class,'inactive'])->name('commisions.inactive');
    Route::post('commisions/active', [AffiliateCommisionController::class,'active'])->name('commisions.active');
    Route::post('commisions/destroy', [AffiliateCommisionController::class,'destroy'])->name('commisions.destroy');
    ...
    Route::get('order/ticket/{invoice_id}', [OrderController::class,'ticket'])->name('admin.order.ticket');
    ...
    Route::get('commision-report', [OrderController::class,'commision_report'])->name('admin.commision_report');
    ...
    Route::post('customer/delete', [CustomerManageController::class,'delete'])->name('customers.delete');
    ...
    Route::post('customer/ip-destroy', [CustomerManageController::class,'ipblock_destroy'])->name('customers.ipblock.destroy');
     Route::post('/customer/savings', [CustomerManageController::class, 'savings'])->name('customer.savings');
    Route::post('/withdraw', [CustomerManageController::class, 'withdraw'])->name('withdraw');
    Route::get('/withdraw/invoice', [CustomerManageController::class, 'invoice'])->name('customer.withdraw.invoice');
    Route::get('/withdraw/{status}', [CustomerManageController::class, 'withdraw_manage'])->name('customer.withdraw_manage');
    Route::get('/withdraw-process', [CustomerManageController::class, 'withdraw_process'])->name('customer.withdraw_process');
    Route::post('/withdraw-change', [CustomerManageController::class, 'withdraw_change'])->name('customer.withdraw_change');
    Route::get('/withdraw-change-multiple', [CustomerManageController::class, 'withdraw_change_multiple'])->name('customer.withdraw_change_multiple');
    Route::get('/multiple_destroy', [CustomerManageController::class, 'multiple_destroy'])->name('customer.multiple_destroy');
